...
-  Outside of the mid-throttle deadzone the vehicle will descend or climb depending upon the deflection of
   the stick.  When the stick is completely down the QuadPlane will descend at :ref:`Q_PILOT_SPD_DN<Q_PILOT_SPD_DN>` and if at the very top it will climb by :ref:`Q_PILOT_SPD_UP<Q_PILOT_SPD_UP>`.
