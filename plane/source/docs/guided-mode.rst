...
Note that if its a climb it will climb as fast as possible, where as a descent will glide such that 
...
requested via MAVLink commands or using Lua. If the aircraft receives a GUIDED_CHANGE_HEADING `GUIDED_CHANGE_HEADING <https://mavlink.io/en/messages/common.html#GUIDED_CHANGE_HEADING>`__
