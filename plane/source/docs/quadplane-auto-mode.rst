...
.. note:: Be sure that the NAV_VTOL_LAND is placed with enough distance to reach the Q_FW_LND_APR_RAD, plus at least a 90 degree turn, plus distance required to de-transition to VTOL mode.
