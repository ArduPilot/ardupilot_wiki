...
-  :ref:`RTL_SPEED <RTL_SPEED>` can be used to set the speed (in meters/second) at which the vehicle will return to home.  By default this parameter is zero, meaning the :ref:`WP_SPEED <WP_SPEED>` parameter values will be used, or :ref:`CRUISE_SPEED <CRUISE_SPEED>` in versions preceding Rover 4.0, if :ref:`WP_SPEED <WP_SPEED>` is also 0.
