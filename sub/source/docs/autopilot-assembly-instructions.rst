...
==============================================
Autopilot System Assembly Instructions for Sub
==============================================

**UNDER CONSTRUCTION**

This section contains the wiring instructions for assembling the autopilot and other *essential components* of Sub:

.. note:: Autopilots usually have connection/wiring details included in their description page linked from :ref:`ArduPilot Autopilots<common-autopilots>`.
