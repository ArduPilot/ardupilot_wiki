...
+---------+-----------------------+---------------------------------------------------------------------------+
| 51      | relay_1_on            | Set the ``RELAY1_PIN`` output to HIGH.                                    |
+---------+-----------------------+---------------------------------------------------------------------------+
| 52      | relay_1_off           | Set the ``RELAY1_PIN`` output to LOW.                                     |
+---------+-----------------------+---------------------------------------------------------------------------+
| 53      | relay_1_toggle        | Toggle the ``RELAY1_PIN`` output between HIGH and LOW.                    |
+---------+-----------------------+---------------------------------------------------------------------------+
| 54      | relay_2_on            | Set the ``RELAY2_PIN`` output to HIGH.                                    |
+---------+-----------------------+---------------------------------------------------------------------------+
| 55      | relay_2_off           | Set the ``RELAY2_PIN`` output to LOW.                                     |
+---------+-----------------------+---------------------------------------------------------------------------+
| 56      | relay_2_toggle        | Toggle the ``RELAY2_PIN`` output between HIGH and LOW.                    |
+---------+-----------------------+---------------------------------------------------------------------------+
| 57      | relay_3_on            | Set the ``RELAY3_PIN`` output to HIGH.                                    |
+---------+-----------------------+---------------------------------------------------------------------------+
| 58      | relay_3_off           | Set the ``RELAY3_PIN`` output to LOW.                                     |
+---------+-----------------------+---------------------------------------------------------------------------+
| 59      | relay_3_toggle        | Toggle the ``RELAY3_PIN`` output between HIGH and LOW.                    |
+---------+-----------------------+---------------------------------------------------------------------------+
| 61      | servo_1_inc           | Increase actuator 1 (Servo9 / Aux1 on old firmware).                      |
+---------+-----------------------+---------------------------------------------------------------------------+
| 62      | servo_1_dec           | Decrease actuator 1 (Servo9 / Aux1 on old firmware).                      |
+---------+-----------------------+---------------------------------------------------------------------------+
| 63      | servo_1_min           | Set actuator 1 (Servo9 / Aux1 on old firmware) to its minimum value.      |
+---------+-----------------------+---------------------------------------------------------------------------+
| 64      | servo_1_max           | Set actuator 1 (Servo9 / Aux1 on old firmware) to its maximum value.      |
+---------+-----------------------+---------------------------------------------------------------------------+
| 65      | servo_1_center        | Set actuator 1 (Servo9 / Aux1 on old firmware) to its center value.       |
+---------+-----------------------+---------------------------------------------------------------------------+
| 66      | servo_2_inc           | Increase actuator 2 (Servo10 / Aux2 on old firmware).                     |
+---------+-----------------------+---------------------------------------------------------------------------+
| 67      | servo_2_dec           | Decrease actuator 2 (Servo10 / Aux2 on old firmware).                     |
+---------+-----------------------+---------------------------------------------------------------------------+
| 68      | servo_2_min           | Set actuator 2 (Servo10 / Aux2 on old firmware) to its minimum value.     |
+---------+-----------------------+---------------------------------------------------------------------------+
| 69      | servo_2_max           | Set actuator 2 (Servo10 / Aux2 on old firmware) to its maximum value.     |
+---------+-----------------------+---------------------------------------------------------------------------+
| 70      | servo_2_center        | Set actuator 2 (Servo10 / Aux2 on old firmware) to its center value.      |
+---------+-----------------------+---------------------------------------------------------------------------+
| 71      | servo_3_inc           | Increase actuator 3 (Servo11 / Aux3 on old firmware).                     |
+---------+-----------------------+---------------------------------------------------------------------------+
| 72      | servo_3_dec           | Decrease actuator 3 (Servo11 / Aux3 on old firmware).                     |
+---------+-----------------------+---------------------------------------------------------------------------+
| 73      | servo_3_min           | Set actuator 3 (Servo11 / Aux3 on old firmware) to its minimum value.     |
+---------+-----------------------+---------------------------------------------------------------------------+
| 74      | servo_3_max           | Set actuator 3 (Servo11 / Aux3on old firmware) to its maximum value.      |
+---------+-----------------------+---------------------------------------------------------------------------+
| 75      | servo_3_center        | Set actuator 3 (Servo11 / Aux3 on old firmware) to its center value.      |
+---------+-----------------------+---------------------------------------------------------------------------+
...
+---------+-----------------------+---------------------------------------------------------------------------+
| 101     | relay_4_on            | Set the ``RELAY4_PIN`` output to HIGH.                                    |
+---------+-----------------------+---------------------------------------------------------------------------+
| 102     | relay_4_off           | Set the ``RELAY4_PIN`` output to LOW.                                     |
+---------+-----------------------+---------------------------------------------------------------------------+
| 103     | relay_4_toggle        | Toggle the ``RELAY4_PIN`` output between HIGH and LOW.                    |
+---------+-----------------------+---------------------------------------------------------------------------+
| 104     | relay_1_momentary     | Set the ``RELAY1_PIN`` output to HIGH, while the button is held.          |
+---------+-----------------------+---------------------------------------------------------------------------+
| 105     | relay_2_momentary     | Set the ``RELAY2_PIN`` output to HIGH, while the button is held.          |
+---------+-----------------------+---------------------------------------------------------------------------+
| 106     | relay_3_momentary     | Set the ``RELAY3_PIN`` output to HIGH, while the button is held.          |
+---------+-----------------------+---------------------------------------------------------------------------+
| 107     | relay_4_momentary     | Set the ``RELAY4_PIN`` output to HIGH, while the button is held.          |
+---------+-----------------------+---------------------------------------------------------------------------+
