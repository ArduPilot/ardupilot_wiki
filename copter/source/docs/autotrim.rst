...
With Auto Trim the roll and pitch corrections are captured as you fly in a stable hover. Setup a :ref:`common-auxiliary-functions` switch to "In Flight AHRS trim adjust" ("182"). We will use CH7 in the following:
...
2. Set the CH7 Option to "In Flight AHRS trim adjust" on the Software > Copter Pids screen and press the "Write Params" button
...
Save Trim
~~~~~~~~~
.. note:: the above AUTO TRIM method is preferred since it does not involve moving transmitter trims after RC calibration.
