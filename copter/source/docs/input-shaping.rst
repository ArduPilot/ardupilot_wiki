...
Autotune will set the :ref:`ATC_ACC_P_MAX<ATC_ACC_P_MAX>`, :ref:`ATC_ACC_R_MAX<ATC_ACC_R_MAX>` and :ref:`ATC_ACC_Y_MAX<ATC_ACC_Y_MAX>` parameters to their maximum based on measurements done during the Autotune tests. These values should not be increased beyond what Autotune suggests without careful testing. In most cases pilots will want to reduce these values significantly.

For aircraft designed to carry large directly mounted payloads, the maximum values of :ref:`ATC_ACC_P_MAX<ATC_ACC_P_MAX>`, :ref:`ATC_ACC_R_MAX<ATC_ACC_R_MAX>` and :ref:`ATC_ACC_Y_MAX<ATC_ACC_Y_MAX>` should be reduced based on the minimum and maximum takeoff weight (TOW):

- :ref:`ATC_ACC_P_MAX<ATC_ACC_P_MAX>`  x (min_TOW / max_TOW)
...
- :ref:`PILOT_TKO_ALT_M<PILOT_TKO_ALT_M>`
- :ref:`PILOT_Y_RATE <PILOT_Y_RATE>`
- :ref:`PILOT_Y_RATE_TC <PILOT_Y_RATE_TC>`
- :ref:`LOIT_ACC_MAX_M<LOIT_ACC_MAX_M>`
- :ref:`LOIT_ANG_MAX <LOIT_ANG_MAX>`
- :ref:`LOIT_BRK_ACC_M<LOIT_BRK_ACC_M>`
- :ref:`LOIT_BRK_DELAY <LOIT_BRK_DELAY>`
- :ref:`LOIT_BRK_JRK_M<LOIT_BRK_JRK_M>`
- :ref:`LOIT_SPEED_MS<LOIT_SPEED_MS>`
