...
With Precision Landing enabled and Land mode activated, the external landing target measurements override the GPS solution for the final approach.
...
- :ref:`PLND_LAND_OFS_X <PLND_LAND_OFS_X>` / :ref:`PLND_LAND_OFS_Y <PLND_LAND_OFS_Y>`: Sets the desired landing position of the camera/sensor relative to the target.
