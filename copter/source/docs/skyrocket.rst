...
More developer specific information including how to compile the sonix and ardupilot firmware can be found on the `developer wiki <https://ardupilot.org/dev/docs/skyviper.html>`__.
