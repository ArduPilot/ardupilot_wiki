...
The SkyRocket SkyViper GPS streaming drone uses ArduPilot as its main flight control software. It was SkyRocket's first launch of an ArduPilot based product.  This page provides details for advanced users and potential developers on this RTF drone.
...
.. toctree::
    ...
    Videos <v2450gps-videos>
    Hardware <v2450gps-hardware>
    Throw Mode <v2450gps-throw>
    Using other Ground Stations <v2450gps-gcs>
    Uploading Software <v2450gps-software>
