...
- RC loss via :ref:`FS_THR_ENABLE<FS_THR_ENABLE>` or via lost RC signal for greater than :ref:`RC_FS_TIMEOUT<RC_FS_TIMEOUT>` (default = 1 sec), always disarms on any RC failsafe. "0" ignores RC failsafes
