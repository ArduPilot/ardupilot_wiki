...
The Morakot is a flight controller designed and produced by `Taiphoon <https://taiphoon.com.tw/>`_


.. image:: ../../../images/Morakot_top.jpg
   :target: ../_images/Morakot_top.jpg


.. image:: ../../../images/Morakot_bottom.jpg
   :target: ../_images/MMorakot_bottom.jpg
...
.. image:: ../../../images/Morakot_top_Wired.jpg
   :target: ../_images/Ms/Morakot_top_Wired.jpg


.. image:: ../../../images/Morakot_bottom_Wired.jpg
   :target: ../_imaes/MMorakot_bottom_Wired.jpg
...
Sensors
-------
* `ICM-45686 High-Performance IMU <https://invensense.tdk.com/products/motion-tracking/6-axis/icm-45686/>`_
* `Bosch BMP390 Barometer <https://www.bosch-sensortec.com/products/environmental-sensors/pressure-sensors/bmp390/>`_
* `ST IIS2MDC Magnetometer <https://www.st.com/en/mems-and-sensors/iis2mdc.html>`_

Microprocessor
--------------
* `STM32H743VIT MCU <https://www.st.com/en/microcontrollers-microprocessors/stm32h743vi.html>`_
...
More Information
================
* `Morakot Flight Controller <https://taiphoon.com.tw/morakot-flight-controllor>`_
* `Morakot documentation <https://taiphoon-com.gitbook.io/taiphoon.com-docs/flight-stack/morakot-flight-controller>`_
...
OSD
===
DisplayPort OSD is enabled by default on the HD VTX connector.
...
Loading Firmware
================
Initial firmware load can be done with DFU by plugging in USB with the bootloader button pressed. Then you should load the “XXX_bl.bin” firmware, using your favorite DFU loading tool.
