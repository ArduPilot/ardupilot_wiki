...
=============================
These settings are set as defaults when the firmware is loaded for a typical external analog power monitor. You will need to adjust :ref:`BATT_VOLT_MULT<BATT_VOLT_MULT__AP_BattMonitor_Analog>` and  :ref:`BATT_AMP_PERVLT<BATT_AMP_PERVLT__AP_BattMonitor_Analog>` 17 for whichever monitor is used.
