...
- Any of the supported :ref:`Rangefinders <common-rangefinder-landingpage>`. Up to 9 rangefinders can be used for object avoidance. See :ref:`common-rangefinder-setup` for more information.
