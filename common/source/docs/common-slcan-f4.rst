...
There are two different applications for using SLCAN to modify UAVCAN device parameter: UAVCAN_GUI or Mission Planner. But first, the SLCAN interface must be enabled.
