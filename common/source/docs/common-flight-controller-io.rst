...
.. note:: For detailed guidance on cable design, signal routing, and color coding schemes, especially for larger vehicles with longer wiring runs, see :ref:`Cable Design Guidelines <common-cabling-guide>`.
