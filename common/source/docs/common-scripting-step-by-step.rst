...
#. From your GCS, enable scripting by setting the :ref:`SCR_ENABLE<SCR_ENABLE>` parameter to "1". Restart the simulation by halting it with CTRL+C and restarting sim_vehicle, or in MAVProxy, type ``reboot``.
