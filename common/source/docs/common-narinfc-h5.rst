...
============================
NarinFC-H5 VOLOLAND CO., LTD
============================

Introduction
============

The NarinFC-H5 is a flight controller produced by `VOLOLAND CO., LTD <https://vololand.com/>`_

NarinFC-H5 is an advanced autopilot family designed in-house by VOLOLAND CO., LTD.
...
-  **Sensors**
    ...
    - Accelerometer/Gyroscope: ICM-45686 X2
...
Where to Buy
============
- `NarinFC-H5 VOLOLAND CO., LTD. <https://vololand.com/>`_
...
-  **5. RSSI Port**
    .. image:: ../../../images/NarinFC/13.RSSI.png
      :target: ../../../images/NarinFC/13.RSSI.png
...
-  **9. ADC Port**
    .. image:: ../../../images/NarinFC/12.ADC.png
      :target: ../../../images/NarinFC/12.ADC.png
...
The NarinFC-H5 has 2 analog inputs, one 6V tolerant and one 3.3V tolerant
...
Firmware for these boards can be found here `https://firmware.ardupilot.org <https://firmware.ardupilot.org>`_ in sub-folders labeled “NarinFC-H5”.
