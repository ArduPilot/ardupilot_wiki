...
By \ `GuyMcCaldin <https://diydrones.com/profile/GuyMcCaldin>`__ (original
...
Using a tool that \ `Forrest Frantz <https://www.diydrones.com/profile/ForrestFrantz>`__ developed, we
...
forum
thread \ `(Here!) <https://diydrones.com/forum/topics/vibration-isolation-and-dampening-of-apm-px4-for-version-2-9?xg_source=activity&id=705844%3ATopic%3A1102762&page=21#comments>`__
...
`Shapeways <https://www.shapeways.com/product/45H92T5RS/omnimac-apm-mount-v1-5?li=aeTabs>`__.
