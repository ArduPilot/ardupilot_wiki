...
=====================================
The debug connector includes USART3, which is configured as a debug console by default. To use it as a regular serial port (SERIAL8), modify `hwdef.dat <https://github.com/ArduPilot/ardupilot/blob/master/libraries/AP_HAL_ChibiOS/hwdef/ARK_FPV/hwdef.dat>`_ to add USART3 to the end of the SERIAL_ORDER list:
...
This requires building the firmware locally. See the :ref:`building-the-code` Wiki section for build instructions.