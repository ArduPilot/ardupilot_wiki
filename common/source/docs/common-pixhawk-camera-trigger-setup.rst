...
f) Navigate to the FULL PARAMETER LIST under the main CONFIG/TUNING tab and locate the ``CAM_TRIGG_TYPE`` parameter. This parameter must show as 1 for “RELAY”. If it is not set to 1, change this parameter to 1 before proceeding to the next step.
