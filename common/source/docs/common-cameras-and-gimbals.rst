...
.. note:: be sure to set the :ref:`CAM_MIN_INTERVAL<CAM_MIN_INTERVAL>` to be greater than the fastest the camera can take photos when using the camera trigger functions.
