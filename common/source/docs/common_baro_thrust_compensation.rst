...
.. note:: this features in not included on most ArduPilot standard firmware builds. Use the `custom firmware build server <custom.ardupilot.org>`__ to create a firmware that includes it.
