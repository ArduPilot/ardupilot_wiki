...
The NarinFC-H7 is a flight controller produced by `VOLOLAND CO., LTD <https://vololand.com/>`_
...
Any UART can also be used for RC system connections in ArduPilot, and is compatible with all protocols except PPM. See :ref:common-rc-systems for details. The power rail associated with this connector position is powered via USB or PMU. 
