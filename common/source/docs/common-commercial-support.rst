...
.. raw:: html
    ...
    <tr class="row-even">
        <td><center><a class="first last reference external image-reference" href="https://www.FlyFix.co.il"><img    alt="../_images/flyfix.png" src="../_images/flyfix.png" style="width: 90px;" /></a><br/><br/>Israel</center></td>
        <td><div class="first last line-block">
            <div class="line">Yaad Chen, <a href="mailto:info@flyfix.co.il?Subject=ArduPilot%20commercial%20support"             target="_top">info@flyfix.co.il</a></div>
            <div class="line"><br/></div>
            <div class="line">FlyFix has many years of experience in the drone industry, specializes in R&D and prototyping for commercial and military grade products. <br></div>
            <div class="line">Offering software and hardware R&D under complete test flight suite as an end-to-end solution. For example: custom drone frames, companion computer software, payload integrations, customer defined test flights, etc. </div>
            </div>
        </td>
    </tr>
    <tr class="row-odd">
