...
.. image:: ../../../images/arkflow/ark-dist.jpg
   :target: ../_images/arkflow/ark-dist.jpg
   :width: 450px
...
-  **Sensors**
   ...
   - `Dronecan Mid-Range Distance Sensor Module <https://dronecan.github.io/>`__
...
The sensor is available from `ARK Electronics <https://arkelectron.com/product/ark-dist-mr/>`__.

Connection to Autopilot
-----------------------

- The ARK DIST MR is connected to the CAN bus using a Pixhawk standard 4 pin JST GH cable.
- Multiple sensors can be connected by plugging additional sensors into the ARK DIST MR's second CAN connector.
...
* `ARK DIST MR <https://docs.arkelectron.com/sensor/ark-dist/ardupilot-instructions>`_
