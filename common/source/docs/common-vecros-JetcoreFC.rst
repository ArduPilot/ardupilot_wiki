.. _common-vecros-JetcoreFC:
[copywiki destination="copter,plane,rover,sub,blimp"]
=================
VECROS JETCORE-FC
=================

**JETCORE-FC** is a one stop autopilot and flight computer solution for developers of advanced drone systems demanding high computing power and high level of modularity. 
It is the "core" of the drone containing most of its electronics in a compact form and it provides wide options for software development of the most challenging AI and vision based applications.

.. image:: ../../../images/vecros/jetcorefc/jetcorefc-full.png

It consists of a control part called **DroneCore.Pilot** and a power part called **DroneCore.Power**.
...
`Where to buy <https://store.vecros.com/products/jetcore-flight-controller-board/>`__


JETCORE-FC comes with both Cube and Xavier NX pre-configured, communicating together, and able to control a Multicopter. Developers no longer need to solve basic communication and compatibility issues coming from connecting two different IT worlds. They can start to concentrate on their application needs from the beginning.
...
JETCORE-FC provides easy to use ROS based software stack supporting development of autonomous applications.
...
**DroneCore.Pilot** is based on Cube Orange - the widely used autopilot from CubePilot, running on ArduPilot (or optionally PX4 flight stack) and Nvidia Jetson Xavier NX. Its rich interfaces allow connecting most sensors and other peripherals for drones available on the market.
...
`Product website <https://www.vecros.com/>`__

`Documentation <https://docs.vecros.com/category/jetcore_fc>`__
