...
.. raw:: html
   ...
   <tr>
   <td><strong>Soaring Mode Toggle</strong></td>
   <td>

Selects the :ref:`soaring <soaring>` behaviour - disabled, enabled with manual mode changes, and enabled with automatic mode changes.
