...
- set :ref:`NTF_BUZZ_ENABLE <NTF_BUZZ_ENABLE>` = 0 to disable the buzzer in firmware prior to 4.1. :ref:`NTF_BUZZ_TYPES<>` controls which types of buzzers are enabled: Pin driven buzzers (built-in or external), or DShot based on ESCs.
