...
BatteryTag.lua                              Logging of DroneCAN Battery Tag messages
...
arming-checks.lua                           Scripted Arming Checks that can be individually enabled/disabled
...
throttle_kill.lua                           Forces servo channel below min to kill engines like turbines via switch
