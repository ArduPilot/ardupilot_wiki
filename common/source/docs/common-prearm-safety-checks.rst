...
.. table:: Pre-Arm Failure Messages (All vehicle types)
    ...
    Compass x not healthy                                   At least one compass is not providing data          Check compass's connection to autopilot and :ref:`configuration <common-positioning-landing-page>`
