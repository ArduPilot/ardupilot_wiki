...
.. table:: Pre-Arm Failure Messages
    ...
    Check fence                                             Fence feature has failed to be inialised            Reboot autopilot
    ...
    Generator: Not healthy                                  Generator is not communciating with autopilot       Check :ref:`generator configuration <common-generators>`
    ...
    RELAYx_PIN=y, set SERVOz_FUNCTION=-1                    Relay misconfigured                                 Set SERVOz_FUNCTION to -1
    ...
    RNGFNDx_PIN=y, set SERVOz_FUNCTION=-1                   Rangefinder misconfigured                           Set SERVOz_FUNCTION to -1
    ...
    RPMx_PIN=y, set SERVOz_FUNCTION=-1                      RPM sensor misconfigured                            Set SERVOz_FUNCTION to -1
