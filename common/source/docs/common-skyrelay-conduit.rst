...
- RPIC SkyAssist — Voice enabled prompt to enhance situational awarness.
...
The K01 Conduit kit is pre-crosses the RX/TX inside the case. To connect to Ardupilot flight controllers connect:
...
To enable SOS buzzer using ESC sounds
...
For BYOD instructions see `SKYRELAY Conduit manual <https://www.skyrelay.us/conduit/manual.html>`
