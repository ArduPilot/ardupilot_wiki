...
#. "Squash" your commits. See :ref:`git-interactive-rebase`. There should be onlt one commit for changes related to a given topical change, even if multiple pages with changes are involved.
