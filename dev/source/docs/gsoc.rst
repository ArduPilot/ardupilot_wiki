...
- The :ref:`suggested projects list and previous year GSoC projects <gsoc-ideas-list>` is here. This is a list of our ideas of what would be good to work on, but we are open to other suggestions you make in your application.
...
- The `ArduPilot Discuss Forum GSoC category <https://discuss.ardupilot.org/c/google-summer-of-code/131>`__ is for GSoC topics and should be cross-posted to the #GSoC Discord channel.
- Check out the `Blog <https://discuss.ardupilot.org/c/blog>`__.
- Past conference talks are on the `ArduPilot YouTube channel <https://www.youtube.com/@ardupilot19/playlists>`__.
...
- `Learning the codebase <https://ardupilot.org/dev/docs/learning-the-ardupilot-codebase.html>`__: a short start for how the repo is organized.
- `ArduPilot SITL <https://ardupilot.org/dev/docs/sitl-simulator-software-in-the-loop.html>`__: our simulation tool; help us improve the SITL documentation.
- `SITL with Gazebo <https://ardupilot.org/dev/docs/sitl-with-gazebo.html>`__: extend SITL to physics simulators, including the free and open-source Gazebo simulator.
- `Methodic Configurator <https://github.com/ArduPilot/MethodicConfigurator>`__: if you have your own hardware, this is our recommended setup and configuration tool.
...
If you'd like to discuss your project or ask questions, please create a thread in the `#GSOC category on the ArduPilot forum <https://discuss.ardupilot.org/c/google-summer-of-code>`__. Please read the pinned message there before posting.

.. toctree::
   :titlesonly:

    GSOC Ideas List and previous year GSoC projects <gsoc-ideas-list>
