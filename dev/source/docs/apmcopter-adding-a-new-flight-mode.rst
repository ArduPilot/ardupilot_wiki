...
#. Pick a name for the new mode and add it to the bottom of the control_mode_t enum in `modes.h <https://github.com/ArduPilot/ardupilot/blob/master/ArduCopter/modes.h#L14>`__ just like "NEW_MODE" has been added below.
