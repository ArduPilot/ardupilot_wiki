...
Using the Mission Planner (or similar) go to the Flight Data screen and right-mouse-button click on the map and select "Set EKF Origin".  The vehicle should appear immediately on the map where you clicked.
