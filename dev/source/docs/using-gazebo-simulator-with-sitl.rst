...
We recommend Ubuntu starting from 16.04 or 18.04 as those are the platform used for testing
...
The plugin we will be using is working from gazebo 7 to 9. We recommend gazebo9 as the new developpement will append on this version.
