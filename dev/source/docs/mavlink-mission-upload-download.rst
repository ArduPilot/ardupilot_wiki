...
.. note::
   ...
   any fence/rally transfer attempted over a MAVLink 1 connection with
   a "Need mavlink2 for item transfer" status text; only the main
   mission (``MAV_MISSION_TYPE_MISSION``) works over MAVLink 1.
