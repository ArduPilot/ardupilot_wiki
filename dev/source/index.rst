...
-  `MAVLink* <http://www.qgroundcontrol.org/mavlink/start>`__ -
   ...
   `here <https://diydrones.com/group/arducopterusergroup/forum/topics/mavlink-tutorial-for-absolute-dummies-part-i?xg_source=activity>`__.
-  `UAVCAN* <https://uavcan.org/>`__ -
   Lightweight protocol designed for reliable communication in aerospace and robotic 
   applications via CAN bus. Ardupilot is using the `Libuavcan <https://uavcan.org//Implementations/Libuavcan/>`__,
...
-  The ArduPilot `automatic test system <http://autotest.ardupilot.org/>`__ shows the test status of each commit. It's described `here <https://diydrones.com/profiles/blog/show?id=705844%3ABlogPost%3A703309>`__.
