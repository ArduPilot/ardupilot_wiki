...
This will test navigation. The aircraft should return to you and orbit
overhead at a fixed altitude (which can be set with the \ :ref:`Mission Planner <common-install-mission-planner>`).
