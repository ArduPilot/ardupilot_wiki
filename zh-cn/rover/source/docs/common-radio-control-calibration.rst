...
Rover users may prefer to control both throttle and
roll from the same stick.
...
#. Move the control sticks and toggle switches on your transmitter to
   ...
   Servos should move in the same direction when
   under autopilot control as they do in MANUAL mode. If not, select the
   **Reverse** checkbox for the associated channel. 
